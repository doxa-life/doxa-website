...
function get_uupg_list_translations() {
    return [
        ...
        'population' => __('Population', 'doxa-website'),
        'population_asc' => sprintf( _x( 'Lowest %s', 'number of people', 'doxa-website'), __('Population', 'doxa-website') ),
        'population_desc' => sprintf( _x( 'Highest %s', 'number of people', 'doxa-website'), __('Population', 'doxa-website') ),
        'people_praying' => __('People Praying', 'doxa-website'),
        'people_praying_asc' => sprintf( _x( 'Lowest %s', 'number of people', 'doxa-website'), __('People Praying', 'doxa-website') ),
        'people_praying_desc' => sprintf( _x( 'Highest %s', 'number of people', 'doxa-website'), __('People Praying', 'doxa-website') ),
